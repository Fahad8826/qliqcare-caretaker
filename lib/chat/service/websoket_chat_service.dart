...
// /// LOGGER HELPERS
// /// =====================================================
// void logWS(String msg) => print('🌐 WS => $msg');
//
// class WebSocketService {
//   WebSocket? _webSocket;
//
...
//
//     if (token == null || token.isEmpty) {
//       logWS('❌ No access token');
//       _connectionController.add(false);
//       return;
//     }
//
//     String baseUrl =
//     dotenv.env['BASE_URL']!.replaceAll(RegExp(r'https?://|wss?://'), '');
//
//     final wsUrl = 'wss://$baseUrl/ws/chat/$roomId/?token=$token';
//
...
//
//   void _handleDisconnect() {
//     logWS('🔌 DISCONNECTED room=$_currentRoomId');
//     _isConnected = false;
//     _connectionController.add(false);
//   }
//
...
//   void send(Map<String, dynamic> payload) {
//     if (!_isConnected || _webSocket == null) {
//       logWS('❌ NOT CONNECTED — cannot send ${payload['type']}');
//       return;
//     }
//
//     final message = jsonEncode(payload);
//
//     logWS('📤 SENT => ${payload['type']}');
//     logWS(message);
//
//     _webSocket!.add(message);
//   }
