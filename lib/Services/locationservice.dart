...
//   static bool _isHandlerRegistered = false; // Track if handler is registered
...
//       // Parse as num first, then convert to double
...
//       // Add to stream so subscribers get updates
//       final coords = {
//         "lat": double.parse(lat.toStringAsFixed(6)),
//         "lng": double.parse(lng.toStringAsFixed(6)),
//       };
...
//       // Get credentials for native service
...
//   /// ----------------------------------------------------------
//   /// UPDATE LOCATION TO API (Not used anymore, Kotlin handles this)
//   /// ----------------------------------------------------------
//   static Future<void> updateLocation(double lat, double lng) async {
//     final token = await TokenService.getAccessToken();
//     final url = Uri.parse(
//       "${dotenv.env['BASE_URL']}/api/caretaker/profile/update/",
//     );
...
//       } else {
//         debugPrint("⚠️ Location update failed: ${response.body}");
//       }
//     } catch (e) {
