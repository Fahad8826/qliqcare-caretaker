...
class Profile {
  ...
  Map<String, dynamic> toJson() {
    ...
    if (locationOfTheCaretaker != null &&
        locationOfTheCaretaker!.isNotEmpty) {
      data["location_of_the_caretaker"] = locationOfTheCaretaker;
    }
    if (latitude != null) data["latitude"] = latitude;
    if (longitude != null) data["longitude"] = longitude;

    /// ✅ OPTIONAL: if backend ever accepts these via profile update
    if (dos != null) data["dos"] = dos;
    if (donts != null) data["donts"] = donts;
